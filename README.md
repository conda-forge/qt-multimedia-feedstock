...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/qt-multimedia-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qt-multimedia-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add qt6-multimedia
# for installing globally
pixi global install qt6-multimedia
```
...
It is possible to list all of the versions of `qt6-multimedia` available on your platform:
...
```
pixi search qt6-multimedia --channel conda-forge
```
